      ...
      <nav className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => navigate('/')}>
            <img src={logo} alt="Delhuan Dairy" className="h-12 w-auto transition-transform duration-300 group-hover:scale-110" />
          ...
          <div className="flex items-center space-x-3">
            ...
            {isAuthenticated && user ? (
              <button className="flex items-center space-x-2 group" onClick={() => navigate('/profile')}>
              ...
              <Button className="accent-gradient text-white font-medium px-6 hidden md:flex" size="sm" onClick={() => navigate('/login')}>
                Login
              </Button>
            )}
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex flex-col space-y-2 px-4 pt-3 border-t border-border">
                <Button variant="outline" size="sm" className="flex items-center justify-center space-x-2"
                  ...
                  <Phone className="h-4 w-4" /><span>Call Now</span>
                </Button>
